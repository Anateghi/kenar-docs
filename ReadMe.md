...
## مرحله‌ی نهایی انتشار

قبل از درخواست انتشار نهایی، لطفاً به دقت [پالیسی‌ها و قوانین](https://github.com/divar-ir/kenar-docs/blob/master/policies.md) مربوط به انتشار را مطالعه کنید. این امر به جلوگیری از بروز مشکلات احتمالی در فرآیند انتشار کمک خواهد کرد.

پس از بررسی و اطمینان از تطابق با پالیسی‌ها، لطفاً برای ثبت درخواست انتشار نهایی، از طریق پنل خود اقدام به ثبت تیکت نمایید. تیم پشتیبانی ما درخواست شما را بررسی کرده و در اسرع وقت اقدام‌های لازم را انجام خواهد داد.
...
| 2 | /finder/posts                               | POST   | جستجوی آگهی بر اساس شهر و محله، دسته، کلیدواژه                    | SEARCH_POST                  | -                         | [جستجو در آگهی‌ها][راهنما » اطلاعات آگهی » جستجو]                |
...
- [انتشار نهایی][راهنما » انتشار نهایی]
...
[راهنما » انتشار نهایی]:policies.md
